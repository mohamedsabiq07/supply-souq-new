      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4 pb-8 border-b border-white/10">
          ...
          <div className="flex items-center gap-4 text-xs font-mono text-slate-400">
            <span className="text-rose-400">EST. 2026</span>
            <span>•</span>
        ...
        <div className="pt-10 border-t border-white/10 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-5 flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-rose-500/10 border border-rose-500/30 flex items-center justify-center text-rose-400 font-bold text-lg font-display">
              SS
            </div>
            <div>
          ...
          <div className="md:col-span-7 grid grid-cols-3 gap-4 font-mono text-xs">
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
              ...
              <span className="text-[11px] text-rose-400">DET Licensed</span>
            </div>
            ...
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
              ...
              <span className="text-[11px] text-rose-400">Fastest 5 Bids</span>
            </div>
            ...
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
              ...
              <span className="text-[11px] text-rose-400">Average wholesale</span>
            </div>
          </div>
        </div>
      </div>
